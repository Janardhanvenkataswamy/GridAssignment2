var productData = {
  ...
  const main = document.getElementById("main");
      ...
      name1.textContent = productData.name;
      name1.id = "name";
      ...
      left_container.appendChild(name1);
      ...
      productData.photos.forEach((photo, index) => {
        ...
        if (index === 0) img_btn.style.border = "2px solid #009688";
        img_btn.src = photo;
        ...
        img_btn.addEventListener("click", (event) => {
          ...
          img_btn.style.border = "2px solid #009688";
        });
